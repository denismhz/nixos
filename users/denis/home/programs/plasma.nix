{ config, pkgs, ... }:
{
  enable = false;
  shortcuts = {
    "ActivityManager"."switch-to-activity-5b1a7f3a-119f-46f3-8fcc-2e11acaf9d94" = [ ];
    "Alacritty.desktop"."New" = [ ];
    "Alacritty.desktop"."_launch" = "Alt+Return";
    ...
    "ksmserver"."Lock Session" = [ "Screensaver" "Alt+X" "Meta+L" ];
    ...
    "kwin"."Switch to Desktop 1" = [ "Alt+1" "Ctrl+F1" ];
    ...
    "kwin"."Window Above Other Windows" = "Alt+A";
    "kwin"."Window Below Other Windows" = [ ];
    "kwin"."Window Close" = [ "Alt+F4" "Alt+C" ];
    "kwin"."Window Fullscreen" = [ ];
    "kwin"."Window Grow Horizontal" = [ ];
    "kwin"."Window Grow Vertical" = [ ];
    "kwin"."Window Lower" = [ ];
    "kwin"."Window Maximize" = [ "Meta+PgUp" "Alt+F" ];
    "kwin"."Window Maximize Horizontal" = "Alt+M";
    ...
    "kwin"."Window One Desktop Down" = [ "Meta+Ctrl+Shift+Down" "Ctrl+Shift+J" "Alt+Shift+J" ];
    "kwin"."Window One Desktop Up" = [ "Alt+Shift+K" "Meta+Ctrl+Shift+Up" ];
    "kwin"."Window One Desktop to the Left" = [ "Alt+Shift+H" "Meta+Ctrl+Shift+Left" ];
    "kwin"."Window One Desktop to the Right" = [ "Meta+Ctrl+Shift+Right" "Alt+Shift+L" ];
    ...
    "kwin"."Window Pack Up" = [ ];
    "kwin"."Window Quick Tile Bottom" = [ "Meta+Down" "Alt+J" ];
    "kwin"."Window Quick Tile Bottom Left" = "Alt+G";
    "kwin"."Window Quick Tile Bottom Right" = "Alt+Ö";
    "kwin"."Window Quick Tile Left" = [ "Alt+H" "Meta+Left" ];
    "kwin"."Window Quick Tile Right" = [ "Alt+L" "Meta+Right" ];
    "kwin"."Window Quick Tile Top" = [ "Alt+K" "Meta+Up" ];
    "kwin"."Window Quick Tile Top Left" = "Alt+#";
    "kwin"."Window Quick Tile Top Right" = "Alt+Ä";
    "kwin"."Window Raise" = [ ];
    "kwin"."Window Resize" = [ ];
    "kwin"."Window Shade" = [ ];
    ...
    "librewolf.desktop"."_launch" = "Alt+W";
    ...
    "org.kde.dolphin.desktop"."_launch" = [ "Alt+N" "Meta+E" ];
    ...
    "org.kde.krunner.desktop"."_launch" = [ "Search" "Alt+Space" "Alt+F2" "Alt+D" ];
  ...
  configFile = {
    ...
    "dolphinrc"."PreviewSettings"."Plugins" = "mltpreview,comicbookthumbnail,ebookthumbnail,imagethumbnail,svgthumbnail,opendocumentthumbnail,audiothumbnail,kraorathumbnail,windowsimagethumbnail,exrthumbnail,windowsexethumbnail,djvuthumbnail,fontthumbnail,jpegthumbnail,ffmpegthumbs,rawthumbnail,mobithumbnail,gsthumbnail,directorythumbnail,blenderthumbnail";
    "kactivitymanagerdrc"."activities"."5b1a7f3a-119f-46f3-8fcc-2e11acaf9d94" = "Default";
    "kactivitymanagerdrc"."main"."currentActivity" = "5b1a7f3a-119f-46f3-8fcc-2e11acaf9d94";
    ...
    "kded5rc"."Module-kscreen"."autoload" = false;
    ...
    "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "983,628";
    ...
    "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 276;
    "kdeglobals"."KFileDialog Settings"."View Style" = "DetailTree";
    "kdeglobals"."KScreen"."ScreenScaleFactors" = "DP-0=1;DP-1=1;DP-2=1;DP-3=1;HDMI-0=1;DP-4=1;";
    ...
    "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{25c30db4-dcef-4cf7-a0c1-d83d4b894a26}";
    ...
    "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{d1b4ca21-f114-4ace-b2f1-2066f6cc96dc}";
    ...
    "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{6f7a96f2-4613-40d3-acc6-5b7ad530162e}";
    ...
    "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{b57e7b59-e9fa-47ef-8181-be42cd7f89ea}";
    ...
    "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{709c163e-69b5-49ff-b67c-50c660ce54be}";
    ...
    "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{06a1a85a-1a8e-48e9-b22c-7d0f81f2a058}";
    ...
    "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{ed34a902-d71d-4ad9-853e-8a03151aae02}";
    ...
    "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/denis/repos/nixos/nixos/share/themes/background.png";
    "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/denis/repos/nixos/nixos/share/themes/background.png";
    ...
    "kwinrc"."Desktops"."Id_1" = "cebb73b9-7b56-4ddf-b2ea-b1d8ed5b9b60";
    "kwinrc"."Desktops"."Id_2" = "966c0f0d-5b29-4aa2-9436-f70643068dff";
    "kwinrc"."Desktops"."Number" = 2;
    "kwinrc"."Desktops"."Rows" = 1;
    "kwinrc"."Effect-blur"."BlurStrength" = 1;
    "kwinrc"."Effect-blur"."NoiseStrength" = 0;
    "kwinrc"."Effect-kwin4_effect_login"."FadeToBlack" = true;
    "kwinrc"."Effect-kwin4_effect_translucency"."Inactive" = 70;
    ...
    "kwinrc"."Tiling.48bced60-0d32-5493-ac6a-396fe957c326"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    "kwinrc"."Tiling.51581e9f-4b0a-5b7a-8613-2fd84f6402c2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    "kwinrc"."Tiling.6e095e16-7b8f-5160-9579-342270366143"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    "kwinrc"."Tiling.7ac27bb9-8119-5a31-9b9f-bbbed84596f1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    "kwinrc"."Tiling.c06ca828-15fe-5c90-b7c6-56916390b245"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    "kwinrc"."Tiling.e61ec543-d222-5fc7-a86d-49f0c02bb114"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    "kwinrc"."org.kde.kdecoration2"."BorderSize" = "None";
    "kwinrc"."org.kde.kdecoration2"."BorderSizeAuto" = false;
    "kwinrc"."org.kde.kdecoration2"."ButtonsOnLeft" = "";
    "kwinrc"."org.kde.kdecoration2"."ButtonsOnRight" = "FIAX";
    "kwinrulesrc"."1"."Description" = "Window settings for alacritty";
    "kwinrulesrc"."1"."clientmachine" = "localhost";
    "kwinrulesrc"."1"."noborder" = true;
    "kwinrulesrc"."1"."noborderrule" = 2;
    "kwinrulesrc"."1"."size" = "1339,998";
    "kwinrulesrc"."1"."title" = "denis@nixos-denis bash";
    "kwinrulesrc"."1"."titlematch" = 1;
    "kwinrulesrc"."1"."types" = 1;
    "kwinrulesrc"."1"."wmclass" = "alacritty";
    "kwinrulesrc"."1"."wmclassmatch" = 1;
    "kwinrulesrc"."2"."Description" = "Window settings for whatsie";
    "kwinrulesrc"."2"."clientmachine" = "localhost";
    "kwinrulesrc"."2"."size" = "1339,998";
    "kwinrulesrc"."2"."sizerule" = 3;
    "kwinrulesrc"."2"."title" = "WhatSie: WhatsApp";
    "kwinrulesrc"."2"."titlematch" = 1;
    "kwinrulesrc"."2"."types" = 1;
    "kwinrulesrc"."2"."wmclass" = "whatsie";
    "kwinrulesrc"."2"."wmclassmatch" = 1;
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."Description" = "Window settings for alacritty";
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."clientmachine" = "localhost";
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."title" = "Alacritty";
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."titlematch" = 1;
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."types" = 1;
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."wmclass" = "alacritty";
    "kwinrulesrc"."2840ac09-805a-440c-ac9d-fa4ecb443817"."wmclassmatch" = 1;
    "kwinrulesrc"."3"."Description" = "Window settings for whatsie";
    "kwinrulesrc"."3"."clientmachine" = "localhost";
    "kwinrulesrc"."3"."size" = "1339,998";
    "kwinrulesrc"."3"."sizerule" = 3;
    "kwinrulesrc"."3"."title" = "WhatSie: WhatsApp";
    "kwinrulesrc"."3"."titlematch" = 1;
    "kwinrulesrc"."3"."types" = 1;
    "kwinrulesrc"."3"."wmclass" = "whatsie";
    "kwinrulesrc"."3"."wmclassmatch" = 1;
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."Description" = "Window settings for alacritty";
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."clientmachine" = "localhost";
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."title" = "bash in ~";
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."titlematch" = 1;
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."types" = 1;
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."wmclass" = "alacritty";
    "kwinrulesrc"."85803d16-9f11-4821-823d-9ce2246b6071"."wmclassmatch" = 1;
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."Description" = "Window settings for vscodium";
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."clientmachine" = "localhost";
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."noborder" = true;
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."noborderrule" = 2;
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."title" = "vscode.nix - nixos - VSCodium";
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."types" = 1;
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."windowrole" = "browser-window";
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."windowrolematch" = 1;
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."wmclass" = "vscodium";
    "kwinrulesrc"."980dcb23-ccae-4b5a-904e-a34eef8c67b6"."wmclassmatch" = 1;
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."Description" = "Window settings for alacritty";
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."clientmachine" = "localhost";
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."noborder" = true;
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."noborderrule" = 4;
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."title" = "denis@nixos-denis bash";
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."titlematch" = 1;
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."types" = 1;
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."wmclass" = "alacritty";
    "kwinrulesrc"."99e8ceca-3a3b-4428-8a3e-10977a661fb1"."wmclassmatch" = 1;
    "kwinrulesrc"."General"."count" = 2;
    "kwinrulesrc"."General"."rules" = "1,2";
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."Description" = "Application settings for alacritty";
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."clientmachine" = "localhost";
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."noborder" = true;
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."noborderrule" = 2;
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."wmclass" = "alacritty";
    "kwinrulesrc"."d1e35364-8b53-4862-990d-988378d9910e"."wmclassmatch" = 1;
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."Description" = "Window settings for alacritty";
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."clientmachine" = "localhost";
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."opacityactive" = 88;
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."opacityactiverule" = 2;
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."title" = "Alacritty";
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."titlematch" = 1;
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."types" = 1;
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."wmclass" = "alacritty";
    "kwinrulesrc"."d3c2648d-4ef6-4a20-bc09-01532a64adde"."wmclassmatch" = 1;
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."Description" = "Window settings for whatsie";
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."clientmachine" = "localhost";
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."size" = "1339,998";
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."sizerule" = 3;
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."title" = "WhatSie: WhatsApp";
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."titlematch" = 1;
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."types" = 1;
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."wmclass" = "whatsie";
    "kwinrulesrc"."e5cf4199-aef4-4ece-b66f-aad3c092c2fe"."wmclassmatch" = 1;
