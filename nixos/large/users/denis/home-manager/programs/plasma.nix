{ config, pkgs, ... }:
{
  ...
  configFile = {
    ...
    "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/nix/store/pdb1dbjfrihx6wdbq76ahgh0ia1vbiia-breeze-qt5-5.27.6-bin/share/wallpapers/Next/";
    "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/nix/store/pdb1dbjfrihx6wdbq76ahgh0ia1vbiia-breeze-qt5-5.27.6-bin/share/wallpapers/Next/";
